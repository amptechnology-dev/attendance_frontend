...
export default function Component({ staffs = [] }) {
  ...
  async function handleSubmit(e) {
    ...
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_URI}/admin/report/salary?${query}`,
      {
        credentials: "include",
      }
    );
          ...
          <div className="grid grid-cols-4 gap-4 mb-3">
            ...
            {/* <div>
              ...
              <Select id="status" name="status">
                ...
                <option defaultValue="full-day">full-day</option>
                <option defaultValue="full-day">half-day</option>
                <option defaultValue="full-day">present</option>
                <option defaultValue="full-day">absent</option>
              </Select>
            </div> */}
            <div>
              <div className="mb-2 block">
