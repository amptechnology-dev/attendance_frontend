  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URI}/admin/duty-timing/update`,
        {
          method: "PUT",
  ...
  return (
    <>
      ...
      <Modal show={openModal} size="md" onClose={onCloseModal}>
        <Modal.Header> Edit Duty Timings </Modal.Header>
        <Modal.Body>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <TextInput
                    ...
                    id="firstHalfEnd"
                    name="firstHalfEnd"
                    defaultValue={data?.firstHalfEnd}
                    required
                  />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <TextInput
                    ...
                    defaultValue={data?.secondHalfStart}
                    required
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <TextInput
                    ...
                    id="halfDay"
                    name="halfDayAllowed"
                    defaultValue={data?.halfDayAllowed}
                    min={0}
                    max={10}
                    required
                  />
